          ...
          <div className="calendar-inner-container rounded-2xl p-4" style={{ backgroundColor: '#FBF8F9' }}>
            <Calendar
              ...
              classNames={{
                ...
                nav_button: "cycle-calendar-nav-button h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
                ...
                day: "cycle-calendar-day h-9 w-9 p-0 font-normal aria-selected:opacity-100",
