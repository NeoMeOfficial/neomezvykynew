  ...
  return <div className="w-full space-y-4">
      ...
      <div className="mt-2 grid grid-cols-2 gap-2">
        ...
        <Button 
          ...
          className="flex items-center gap-2 text-base bg-gradient-to-r from-rose-50/80 to-pink-50/80 border border-rose-200/30 backdrop-blur-sm rounded-3xl px-6 py-3 hover:from-rose-50 hover:to-pink-50 transition-all"
          style={{ color: '#F4415F' }}
        >
