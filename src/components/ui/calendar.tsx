  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-12 h-12 font-medium text-base flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-12 w-12 p-0 font-medium text-lg aria-selected:opacity-100 rounded-xl"
        ),
