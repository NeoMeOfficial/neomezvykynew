...
const Checkout = () => {
  ...
  const features = [{
    ...
    icon: Sparkles,
    text: 'Zdieľaj kalendár s partnerom či lekárom'
  }];
  ...
  return <div className="min-h-screen bg-[hsl(var(--shell))]">
      {/* Header */}
          ...
          <div>
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-[hsl(var(--widget-border))]">
              ...
              <div className="space-y-2.5 mb-5">
                <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border-2 border-[hsl(var(--widget-border))] hover:border-[#F4415F]/30 hover:bg-[#FEF5F7]/50 transition-all font-medium text-sm text-[#955F6A]">
                ...
                <button onClick={handleAppleLogin} className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border-2 border-[hsl(var(--widget-border))] hover:border-[#F4415F]/30 hover:bg-[#FEF5F7]/50 transition-all font-medium text-sm text-[#955F6A]">
              ...
              handlePayment();
                ...
                <div>
                  ...
                  <Input id="email" type="email" placeholder="tvoj@email.com" value={email} onChange={e => setEmail(e.target.value)} className="h-11 rounded-xl border-2 focus:border-[#F4415F]" required />
                </div>
                <div>
                  <Label htmlFor="password" className="text-[#955F6A] font-medium text-sm mb-1.5 block">Heslo</Label>
                  <Input id="password" type="password" placeholder="Minimálne 8 znakov" value={password} onChange={e => setPassword(e.target.value)} className="h-11 rounded-xl border-2 focus:border-[#F4415F]" minLength={8} required />
                </div>
                ...
                <Button type="submit" className="w-full h-12 text-base font-semibold rounded-xl mt-4" style={{
