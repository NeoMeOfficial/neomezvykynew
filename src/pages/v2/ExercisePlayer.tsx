              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-serif text-[14px] text-ink truncate">
                    {row.titleParts
                      ? <>{row.titleParts.before}{' '}<strong className="font-bold text-[15px]" style={{ color: '#B8864A' }}>{row.titleParts.em}</strong><span className="font-sans text-[10px] font-semibold text-ink/40 ml-0.5">{row.titleParts.num}</span></>
                      : row.title}
                  </div>
