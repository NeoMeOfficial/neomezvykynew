...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { name: 'Sriracha omáčky', amount: '½ ČL' },
      { name: 'Turmeriku tuku', amount: '½ ČL' },
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Paradajkovej pasty', amount: '2 ks' },
      { name: 'Mletého hovädzieho mäsa', amount: '500 g' },
      { name: 'Olivový olej v spreji', amount: 'na postriekanie' },
      { name: 'Paradajok v plechovk', amount: '400 g' },
      { name: 'Sladkých zemiakov', amount: '400 g' },
      { name: 'Šošovice v plechovk', amount: '400 g' },
      { name: 'Soľ, korenie a petržlen', amount: 'podľa chuti' },
      { name: 'Čerstvá vňať na ozdobu', amount: '1 PL' },
      { name: '+ 1 cibuľa zahradny salat', amount: '1 ks' },
  ...
  },
  {
    ...
    fiber: 7,
    ingredients: [
      { name: 'Batáty, ošúpané', amount: '150 g' },
      { name: 'Nakrájaných', amount: '100 g' },
      { name: 'Cl dijónskej horčic', amount: '1' },
      { name: 'Hnedej šošovice . | cl medu', amount: '1 PL' },
  ...
  },
  {
    ...
    fiber: 7,
    ingredients: [
      { name: 'Špaldový wrap', amount: '1 ks' },
      { name: 'Hummusu', amount: '1 PL' },
      { name: 'Falafel guličiek', amount: '150 g' },
      { name: 'Rajčina', amount: '1 ks' },
      { name: '% uhorky', amount: '½ ks' },
      { name: 'Nízkotučného syra alebo syrovej náhrady', amount: '15g' },
      { name: 'Špenátu', amount: '2 hrste' },
      { name: 'Tabouli', amount: '1,5 PL' },
      { name: 'Pl tzatziki alebo gréckeho jogurtu', amount: '150 g' },
      { name: 'Limetková šťava', amount: '½ ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '1/4 červenej cibul', amount: '1 ks' },
      { name: '(alebo ryby/ kuracie mäso)', amount: '½ ks' },
      { name: 'Šálka varenej hnedej ryž', amount: '1' },
      { name: '1/2 zväzku koriandra', amount: '1 PL nasekaného' },
      { name: 'Kukurica', amount: '1' },
      { name: 'Lyžička mletej papriky', amount: '1' },
      { name: 'Čiernej fazule z plechovky', amount: '200 g' },
      { name: 'Cherry paradajok', amount: '120 g' },
      { name: 'Malá uhorka', amount: '1' },
      { name: 'Polievková lyžica sladkej', amount: '1' },
      { name: '1/2 manga chilli omáčky', amount: '100 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Hovädzieho mäsa', amount: '200 g' },
      ...
      { name: 'Rozšľahané vajce', amount: '1' },
      { name: 'strúhanky', amount: '1/4 šálky' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Nakrájaných na kocky', amount: '100 g' },
      { name: 'Čerstvého zázvoru', amount: '1 cm' },
      { name: 'Šálka hnedej ryž', amount: '1' },
      { name: '1/4 zväzku koriandra', amount: '1 PL nasekaného' },
      { name: 'sezamového oleja', amount: '1/2 pl' },
      { name: 'sójovej omáčky', amount: '1 pl' },
      { name: '1/4 zväzku brokolic', amount: '150 g' },
      { name: '2/3 limetky', amount: '½ ks' },
      { name: '1/2 mrkvy', amount: '1 ks' },
      { name: '1/4 limetkovej kôry', amount: '½ ks' },
      { name: 'Fazule edamam', amount: '100 g' },
      { name: 'Medu', amount: '1 PL' },
      { name: '1/2 červenej papriky', amount: '1 ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Chudého hovädzieho mäsa/', amount: '125 g' },
      { name: 'Kuracieho mäsa cibuľa, avokádo a kyslá', amount: '1 ks' },
      { name: 'Obľúbená fazuľa z plechovky smotana - alebo čokoľvek,', amount: '100 g' },
      { name: 'Taco korenie na tortilly . na čo máš chuť', amount: 'podľa chuti' },
      { name: 'Vody', amount: '250 ml' },
      { name: 'Listy maslového šalátu/celozrnné', amount: '20 g' },
      { name: 'Tortilly', amount: '1 ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Cibule, nasekanej najemno', amount: '1 ks' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Gréckeho jogurtu', amount: '150 g' },
      { name: 'Gsladkých zemiakov', amount: '200' },
      { name: 'rasc', amount: '1/2 lyžičky' },
      { name: 'Paradajky nakrájané na kocky', amount: '2' },
      { name: '1/4 zväzku bazalky', amount: '1 PL nasekaného' },
      { name: 'Cibuľa', amount: '1 ks' },
      { name: 'Lyžička čili prášku', amount: '1' },
      { name: 'Šálka špenátu', amount: '1' },
      { name: '1/2 mrkvy * olivový olej v spreji', amount: 'na postriekanie' },
      { name: '1/3 šálky hrášku', amount: 'podľa chuti' },
      { name: 'kukuričných zfn', amount: '1/4 šálky' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'edamame alebo', amount: '3/4 šálky' },
      { name: 'Šálka hnedej ryže hnedej fazule/ hrášku/ špargle)', amount: '1' },
      { name: 'Strúhanej mrkvy', amount: '4 šálky' },
      { name: 'Natenko nakrájanej uhorky omáčka na ryžu', amount: '4 šálky' },
      { name: 'Nakrájanej kapusty', amount: '4 šálky' },
      { name: 'V4 hrste čerstvého koriandru', amount: '1 PL nasekaného' },
      { name: 'Medu', amount: '1 PL' },
      { name: 'Sójovej omáčky', amount: '1 PL' },
      { name: 'Sezamové semienka', amount: '20 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Nastrúhaný nastrúhaného', amount: '30 g' },
      { name: 'cukina, nastrúhaná a zbavená', amount: '1 ks' },
      ...
      { name: 'štipka prášku do pečiva', amount: '1 ČL' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Tekvice', amount: '400 g' },
      { name: 'Niekoľko baby zemiakov', amount: '1 PL' },
      { name: 'Veľká mrkva', amount: '1' },
      { name: 'Paštrnák', amount: '1' },
      { name: 'Cuketa', amount: '1' },
      { name: 'Listy šalátu, nakrájané na kúsky', amount: '2 ks' },
      { name: 'Cherry paradajok', amount: '4' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'balzamikového octu', amount: '1/5 pl' },
      { name: '1 žálka take', amount: '0' },
      { name: 'Malej červenej cibule + % citróna', amount: '1 ks' },
      { name: 'mrkva', amount: 'podľa chuti' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Baby špenátu', amount: '2 hrste' },
      { name: 'Brokolica', amount: '150 g' },
      { name: 'Kapusta', amount: '⅛ zväzku' },
      { name: '1/4 zväzku čerstvej bazalky', amount: '1 PL nasekaného' },
      { name: 'Makadamových orechov', amount: '15 g' },
      { name: 'Cherry paradajok', amount: '6' },
      { name: 'Parmezán na ozdobu', amount: '30 g' },
      { name: '1/4 cesnaku', amount: '2 strúčiky' },
      { name: 'Olivového oleja', amount: '1 PL' },
      { name: '1/8 citróna', amount: '½ ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '1/2 avokáda (nakrájaného na', amount: '½ ks' },
      { name: 'Nakrájanej tekvice kocky)', amount: '2 šálky' },
      { name: 'Šálka quinoy', amount: '1' },
      { name: 'Hfstka špenátu', amount: '2 hrste' },
      { name: 'Kukurica (z mini plechoviek alebo', amount: '1 ks' },
      { name: 'Čerstvá) olivoý olej', amount: '1 PL' },
      { name: 'Paradajka (nakrájaná na kocky)', amount: '2 ks' },
      { name: '1/2 uhorky', amount: '½ ks' },
      { name: 'Cibuľu', amount: '1 ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '(alebo len extra hnedej ryže) mesiačiky', amount: '80 g' },
      { name: 'Baby špenátu', amount: '80 g' },
      { name: 'soli', amount: '1/2 lyžička' },
      { name: 'Mletej papriky', amount: '1 ks' },
      { name: 'Soľ a korenie podľa chuti', amount: 'podľa chuti' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'G batátov', amount: '150' },
      { name: 'Špaldová burger žemla', amount: '1' },
      { name: 'Fazule mungo', amount: '50g' },
      { name: 'V, pl mletej rasce', amount: '1 PL nasekaného' },
      { name: 'Mletého koriandru', amount: '½ PL' },
      { name: 'Soľ a čierne koreni', amount: 'podľa chuti' },
      { name: 'rajčinového chutney', amount: '2/3 pl' },
      { name: 'olivový olej', amount: '1 PL' },
      { name: 'Rajčiny', amount: '2 plátky' },
      { name: 'Špenátových lístkov', amount: '5' },
      { name: '% červenej cibul', amount: '1 ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Vw uhorky * 1 čl sezamového oleja', amount: '½ ks' },
      { name: 'Šálka červenej kapusty', amount: '1' },
      { name: 'Neutrálneho oleja', amount: '1 ČL' },
      { name: 'Malé jarné cibuľky, nakrájané', amount: '2' },
      { name: 'Citrónovej šťavy', amount: '1 PL' },
      { name: 'Nakladaného zázvoru,', amount: '10g' },
      { name: 'Nakrájaného na tenké plátky', amount: '100 g' },
      { name: 'Čl štipľavej čili pasty', amount: '1' },
      { name: 'Čierne sezamové semienka', amount: '20 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '1/3 mrkvy', amount: '1 ks' },
      { name: '1/4 jarnej cibuľky', amount: '1 ks' },
      { name: 'Slnečnicových semienok', amount: '20 g' },
      { name: 'Sol a koreni', amount: 'podľa chuti' },
      { name: 'Celozrnný wrap', amount: '1' },
      { name: 'červenej kapusty', amount: '1/2 šálky' },
      { name: 'pečených sladkých', amount: '1/2 šálky' },
      { name: 'Zemiakov', amount: '200 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Cibule, nasekané najemno', amount: '2' },
      { name: 'Cuketa, nastrúhaná najemno', amount: '1' },
      { name: 'Mrkvy, očistené a nakrájané', amount: '2' },
      { name: 'Nadrobno', amount: '2 PL' },
      { name: 'Bobkové listy', amount: '2' },
      { name: 'Cesnaku, pretlačné', amount: '2 strúčiky' },
      { name: 'Parmezánu', amount: '25 g' },
      { name: 'Chudé mleté hovädzie mäso', amount: '500 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Va šálky feta syru - rozdrobeného', amount: '30 g' },
      { name: 'Xtra panenský olivový olej', amount: '1 PL' },
      { name: 'Soľ a čierne koreni', amount: 'podľa chuti' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'sušeného tymiánu', amount: '1/2 lyžičky' },
      { name: 'Hub', amount: '95 g' },
      ...
      { name: 'Drobné kocky', amount: '100 g' },
      { name: 'Kukuričnej múky', amount: '15 g' },
      { name: '° 30 g čiernej ryž', amount: '80 g' },
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Kuracieho mäsa zo stehna', amount: '135 g' },
      ...
      { name: 'Cesnakového korenia', amount: '2 strúčiky' },
      { name: 'Taco omáčky', amount: '100 ml' },
      { name: 'Kuracieho vývaru', amount: '330 ml' },
      { name: 'Kukuric', amount: '10g' },
      { name: 'Čiernej fazul', amount: '100 g' },
      { name: 'Koriander', amount: '1 PL nasekaného' },
      { name: 'Gréckeho jogurtu', amount: '1 PL' },
      { name: 'Kuracie mäso. zatvor sáčok a poriadne ním zatras, aby sa mäso obalilo v', amount: '200 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Kocka kuracieho bujónu', amount: '200 g' },
      { name: 'Zelené šalotky', amount: '3' },
      { name: 'Malá plechovka kukurice', amount: '1' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'pl čerstvého zázvoru, na kocky', amount: '1 cm' },
      { name: 'Edamam', amount: '100 g' },
      { name: 'Nastrúhaného', amount: '30 g' },
      { name: 'Červená cibuľa a mangold', amount: '60 g' },
      { name: 'Zelenina, nakrájaná nahrubo', amount: '100 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Coleslaw šalátu', amount: '¼ porcie' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Medu', amount: '1 PL' },
      { name: 'štipka soli a korenia podľa chuti', amount: 'podľa chuti' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Zeleru, nakrájaného na plátky', amount: '90 g' },
      { name: 'Cibuľa, nasekaná najemno', amount: '1 ks' },
      { name: 'Mletý koriander', amount: '1 ČL' },
      ...
      { name: 'Konzervovaná zelenina', amount: '400 g' },
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'V4 šálky hnedej alebo zelenej šošovice + šálka šalátovej zeleniny (kel,', amount: '2 hrste' },
      { name: 'Mrkva, nakrájaná na plátky kapusta, zelená cibuľka)', amount: '1' },
      { name: 'Zeler, nakrájaný na plátky', amount: '1' },
      { name: 'Veľké nasekané šampiňóny', amount: '4' },
      { name: 'Cesnaku, pretlačeného', amount: '2 strúčiky' },
      { name: 'Zeleninový vývar', amount: '250 ml' },
      { name: 'Výhonky rozmarínu alebo', amount: '1' },
      { name: 'nasekaných baby zemiakov tymiánu', amount: '2/3 šálky' },
      { name: 'Trochu citrónovej šťavy', amount: '½ ks' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Húb nakrájaných na plátky', amount: '70 g' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Banán', amount: '1' },
      { name: 'Nakrájaný na plátky a zmrazený)', amount: '1 ks' },
      { name: 'Mrazeného pyré acai', amount: '100 g' },
      { name: 'Čučoriedok (jedno balenie)', amount: '4 šálky' },
      { name: '% šálky jahôd', amount: '80 g' },
      { name: 'Nesladeného mandľového kokos a lyžica semienok na', amount: '20 g' },
      { name: 'Mlieka ozdobu', amount: '200 ml' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 4,
    ingredients: [
      { name: 'Kváskový chlieb', amount: '2 plátky' },
      { name: 'Avokáda', amount: '½ ks' },
      { name: 'Tety', amount: '25 g' },
      { name: 'Prekrojené cherry rajčiny', amount: '3' },
      { name: 'Lístky bazalky', amount: '2' },
      { name: 'Citrónová šťava', amount: '½ ks' },
      { name: 'Čierne koreni', amount: 'podľa chuti' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Ovoci', amount: '100 g' },
      { name: 'Orechové maslo', amount: '20 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'So 6 lyžicami vody', amount: '250 ml' },
      { name: 'Celozrnnej hladkej múky', amount: '290 g' },
      { name: 'Lyžička prášku do pečiva', amount: '1 ČL' },
      { name: 'sódy bikarbóny', amount: '1/2 lyžičky' },
      { name: 'škoric', amount: '1/2 lyžičky' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Kváskového chleba', amount: '2 plátky' },
      { name: 'Vw avokáda', amount: '½ ks' },
      { name: 'Citrónová šťava', amount: '½ ks' },
      { name: 'Sezamových semienok,', amount: '1 ČL' },
      { name: 'Opražených', amount: '20 g' },
      ...
      { name: 'Soľ a čierne korenie podľa chuti', amount: 'podľa chuti' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Veľké vajcia', amount: '2' },
      { name: 'Baby špenátu', amount: '30 g' },
      { name: 'chilli vločiek', amount: '1/2 lyžičky' },
      { name: 'Šampiňónov, nakrájaných', amount: '40 g' },
      { name: 'Plátok kváskového chleba, opečený', amount: '1 plátok' },
      { name: 'Rozdrvený strúčik cesnaku', amount: '2 strúčiky' },
      { name: 'strúhaného parmezánu', amount: '1/2 lyžice' },
      { name: 'Vetvička nasekanej petržlenovej vňat', amount: '1 PL nasekaného' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Mrazený banán', amount: '1 ks' },
      { name: '% šálky nesladeného mandľového', amount: '1 ks' },
      { name: 'Mlieka', amount: '20 g' },
      { name: 'Odmerka proteínu okvapkani', amount: '30 g' },
      { name: 'Polievková lyžica kakaa', amount: '1 ČL' },
      { name: 'Polievková lyžica chia semienok', amount: '20 g' },
      { name: 'Malá hrsť špenátu', amount: '2 hrste' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Čerstvých jahôd', amount: '80 g' },
      { name: '1/2 banánu', amount: '1 ks' },
      { name: 'Mandľového mlieka', amount: '200 ml' },
      { name: 'Odmerka čokoládového', amount: '1' },
      { name: 'Proteínového prášku', amount: '30 g' },
      { name: 'Chia semienok', amount: '20 g' },
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'pohánkovej krupice (nie', amount: '1/2 šálky' },
      { name: 'Kaše)', amount: '100 g' },
      { name: '1/4 čajovej lyžičky škoric', amount: '½ ČL' },
      { name: 'štipka soli', amount: 'štipka' },
      { name: 'Ovocia', amount: '100 g' },
      { name: 'Strúhaného kokosu', amount: '1 PL' },
      { name: 'Chia semienok', amount: '20 g' },
      { name: 'Lyžička vegánskeho proteínu', amount: '1 odmerka (30 g)' },
      { name: 'Kokosové mlieko', amount: '200 ml' },
      { name: 'Mlieka (alebo iného) (voliteľné)', amount: '200 ml' },
      { name: 'Šálka nesladeného mandľového chia/ orechy/ kúsky čokolády', amount: '20 g' },
      { name: 'Mlieka na ozdobu', amount: '200 ml' },
      { name: 'Šálka vody', amount: '250 ml' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '° 60g nakrájanej kyslej kapusty', amount: '1 PL' },
      { name: 'Čajová lyžička opražených', amount: '2 ČL' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Prášku (whey protein izolát)', amount: '30 g' },
      { name: 'Kokosových lupienkov', amount: '1 ČL' },
      { name: 'malá mrkva, očistená a', amount: '1 ks' },
      { name: 'Nastrúhaná', amount: '1 ks' },
      { name: 'Ovsených vločiek (ženská', amount: '½ šálky' },
      { name: 'Porcia) alebo 1 šálka ovsených', amount: '50 g' },
      { name: 'Vločiek (mužská porcia)', amount: '50 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Mlieka (alebo iného)', amount: '200 ml' },
      { name: 'Odmerka (30 g) proteínového', amount: '1' },
      { name: 'Proteínový prášok', amount: '30 g' },
      { name: 'Mrazených čučoriedok', amount: '80 g' },
      { name: 'Alebo jahôd, prípadne orechy', amount: '20 g' },
      { name: 'ovsených vločiek', amount: '1/2 šálky' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'ovsených vločiek', amount: '1/2 šálky' },
      { name: 'štipka soli', amount: 'štipka' },
      { name: 'Nízkotučného alebo mandľového mlieka', amount: '200 ml' },
      { name: 'Gréckeho vanilkového jogurtu', amount: '150 g' },
      { name: 'Čerstvých čučoriedok (alebo rozmrazených bobúľ)', amount: '80 g' },
      { name: 'Lyžica medu', amount: '1 PL' },
      { name: 'Odmerka proteínu (voliteľné)', amount: '30 g' },
      { name: 'Mandle/pekanové orechy (voliteľné)', amount: '20 g' },
      { name: 'Štipka soli', amount: '200 ml' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Listov baby špenátu', amount: '2 hrste' },
      { name: 'Húb', amount: '40g' },
      { name: 'Kozieho syra', amount: '25 g' },
      { name: 'Xtra panenský olivový olej v spreji', amount: 'na postriekanie' },
      { name: 'Lyžička kajenského korenia na dochuteni', amount: '1' },
      { name: 'Plátok celozrnného chleba', amount: '1 plátok' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'V> avokáda', amount: '½ ks' },
      { name: 'Ražného chleba', amount: '2 plátky' },
      { name: 'Pl citrónovej šťavy', amount: '½ ks' },
      { name: 'Čerstvý kôpor (môže byť aj sušený)', amount: '1 PL' },
      { name: 'V, červenej cibul', amount: '1 ks' },
      { name: 'Sezamových semienok', amount: '1 ČL' },
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Javorového sirupu', amount: '½ PL' },
      { name: 'Tahini', amount: '½ PL' },
      { name: 'Tekvicových semiačok', amount: '10 g' },
      { name: 'Hrozienok', amount: '10 g' },
      { name: 'Nesladeného mandľového mlieka 2 veľké nasekané vlašské orechy', amount: '200 ml' },
      { name: 'Ys šálky vody (poprípade trochu 2 pl gréckeho jogurtu', amount: '250 ml' },
      { name: 'Viac mlieka alebo vody ak chcete', amount: '250 ml' },
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Vajc', amount: '2 ks' },
      { name: 'Šunky', amount: '50 g' },
      { name: 'Hladkej múky (alebo pohánkovej múky)', amount: '20 g' },
      { name: 'Syra', amount: '25 g' },
      { name: 'Rukoly', amount: '½ šálky' },
      { name: 'Lyžička dijonskej horčic', amount: '1 ČL' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Červená cibuľa', amount: '1 ks' },
      { name: 'Čili', amount: '½ ČL' },
      { name: 'Limetkovej šťavy', amount: '1 PL' },
      { name: '1/8 hrsť koriandra', amount: '1 PL nasekaného' },
      { name: 'Olivový olej', amount: '1 PL' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Chlieb, ľubovoľný', amount: '2 plátky' },
      { name: '1/2 avokáda', amount: '½ ks' },
      { name: '- 4 strúčiky cesnaku, nahrubo', amount: '2' },
      { name: 'Nasekaných', amount: '2 PL' },
      { name: 'pl balzamikového alebo', amount: '1 PL' },
      { name: 'Jablčného octu', amount: '1 PL' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 6,
    ingredients: [
      { name: 'Pohánkovej múky', amount: '120 g' },
      { name: 'Mandľovej múky', amount: '60 g' },
      { name: 'Oleja', amount: '2 PL' },
      { name: '1čajová lyžička prášku do pečiva  ] čl vanilkového extraktu', amount: '1 ČL' },
      { name: 'Čajovej lyžičky sódy bikarbóny', amount: '½ ČL' },
      { name: 'Čajovej lyžičky mletej škorice nahrubo nasekaných', amount: '½' },
      { name: 'Čajovej lyžičky kuchynskej soli', amount: '½' },
      { name: 'Lyžice ľanového semienka (náhrada nahrubo nasekaných', amount: '2' },
      { name: 'Vajíčka)', amount: '1 PL' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Vody', amount: '250 ml' },
      { name: 'Nízkotučného mlieka', amount: '200 ml' },
      { name: 'Vanilkového proteínu', amount: '30 g' },
      { name: '1/2 mrazeného banánu', amount: '1 ks' },
      { name: 'Lyžička medu', amount: '1 PL' },
      { name: 'škoric', amount: '1/2 lyžičky' },
      { name: 'Vlašských orechov', amount: '20 g' },
      { name: 'Ľad', amount: '1 šálka' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Vanilkového + odmerka kakaa)', amount: '1 ČL' },
      { name: '> mrazeného banánu', amount: '1 ks' },
      { name: 'Hrsť špenátu', amount: '2 hrste' },
      { name: 'Šálka mlieka', amount: '1' },
      { name: 'Ľad', amount: '1 šálka' },
      { name: 'ovsených vločiek', amount: '1/3 šálky' },
    ],
    steps: [
      'Všetky prísady rozmixuj v mixéri do hladka.',
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Vegánskeho proteínového prášku', amount: '30 g' },
      { name: 'Kokosovej vody', amount: '250 ml' },
      { name: 'W% stredného mrazeného banánu', amount: '1 ks' },
      { name: 'V4 šálky mrazených čučoriedok', amount: '80 g' },
      { name: 'Odkôstkovaná mediool datľa', amount: '1' },
      { name: 'Mandlí', amount: '8' },
      { name: 'Ľad', amount: '3-4 kocky' },
      { name: 'Aby bol výsledok čo najviac krémový, banán musí byť poriadne zmrazený', amount: '1 ks' },
    ],
    steps: [
    ],
    allergens: ['nuts'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Javorového sirupu', amount: '2½ čl' },
      { name: 'čl kakaa', amount: '1 ČL' },
      { name: 'Chia semiačok', amount: '1 ČL' },
      { name: 'Himalájskej ružovej soli', amount: '½ ČL' },
      { name: 'Datle medjool', amount: '250 ml' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '1/2 stredne veľkého mrazeného banánu', amount: '1 ks' },
      { name: 'Lyžička javorového sirupu', amount: '1' },
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Vody', amount: '250 ml' },
      { name: 'Odmerka proteínu', amount: '30 g' },
      { name: 'Odmerka zeleného prášku', amount: '1 odmerka' },
      { name: 'Šálka špenátu', amount: '2 hrste' },
      { name: 'Mrazený banán', amount: '1 ks' },
      { name: 'Lyžička medu', amount: '1 PL' },
      { name: 'Ovsených vločiek', amount: '80 g' },
      { name: 'Rastlinného alebo nízkotučného mlieka', amount: '200 ml' },
      { name: 'Kociek ľadu', amount: '½ šálky' },
  ...
  },
  {
    ...
    fiber: 3,
    ingredients: [
      { name: '/2 šálky celých mandlí', amount: '20 g' },
      ...
      { name: 'Pl medu', amount: '2' },
      { name: 'Vanilkového extraktu', amount: '1 ČL' },
      { name: 'Strúhaný kokos na obaleni', amount: '2 PL' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Praclíky bez pridaného cukru)', amount: '1 PL' },
      { name: 'Ovsa', amount: '80 g' },
      { name: 'Datle medjool, bez kôstok', amount: '150 g' },
      { name: 'Nahrubo nasekaných', amount: '2 PL' },
      { name: 'Mandľového masla', amount: '100 g' },
      { name: 'Čistého javorového sirupu', amount: '40 ml' },
      { name: 'Mandľového mlieka', amount: '30 ml' },
      { name: 'mavých čokoládových', amount: '175' },
      { name: 'Lupienkov', amount: '20 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Masla', amount: '20 g' },
      { name: 'Veľké vajcia', amount: '3' },
      { name: 'slnečnicových', amount: '2/3 lyžice' },
      { name: 'Mrkvy, stredne veľké', amount: '2' },
      { name: 'Nastrúhané', amount: '30 g' },
      { name: 'Lyžičky sezamových semienok', amount: '2' },
      { name: 'Gréckeho jogurtu', amount: '60 g' },
      { name: 'Mletého zázvoru', amount: '1 cm' },
      { name: 'Lyžička prášku do pečiva', amount: '1' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Datle medjool, bez kôstok', amount: '135 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'H 4 čl škoric', amount: '½ ČL' },
      { name: 'Medu', amount: '100 g' },
      { name: 'Arašidového masla', amount: '120 g' },
      { name: 'Ovsených vločiek', amount: '10g' },
      { name: 'O g masla', amount: '20 g' },
      { name: 'Arašidového masla)', amount: '20 g' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 3,
    ingredients: [
      { name: 'Zrelý stredne veľký banán ° 1/2 čl škoric', amount: '1 ks' },
      { name: 'nízkotučného alebo + štipka soli', amount: '1/3 šálky' },
      { name: 'Mandľového mlieka', amount: 'na postriekanie' },
      { name: 'Vajc', amount: '1' },
      ...
      { name: 'Na posypanie alebo medu na ozdobu', amount: '1 PL' },
      { name: 'pl gréckeho jogurtu', amount: '150 g' },
      { name: 'vanilky javorového sirupu + malá', amount: '1 čl' },
      { name: 'prášku do pečiva štipka soli', amount: '1/2 čl' },
    ],
    steps: [
  ...
  },
  {
    ...
    fiber: 3,
    ingredients: [
      { name: 'Datle medjool, bez kôstok', amount: '1,5 šálky' },
      ...
      { name: 'Himalájskej ružovej soli', amount: '1 ČL' },
      { name: 'Kokos, sezam, kakao a pod. na obaleni', amount: '2 PL' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: '> mrkvy (stredne veľkej), javorového sirupu)', amount: '1 ks' },
      { name: 'Postrúhanej', amount: '20 g' },
      { name: 'Gvanilkového proteínu opražených a nasekaných', amount: '20' },
      { name: 'Celozrnnej špaldovej múky', amount: '23 g' },
      { name: 'Cl mletej škoric', amount: '½ ČL' },
      { name: 'V, cl prášku do pečiva', amount: '1 ČL' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Sauce: 1/2 tsp sea soľ, 1/2 tsp cesnak powder, 1/2 tsp cumin, 1/4 tsp chili powder, 1/4 tsp turmeric', amount: 'podľa chuti' },
    ],
    steps: [
    ],
    allergens: ['gluten', 'soy'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Top: 1/2 cup jahody, 1/2 banán, 1/2 cup mandle mlieko, 1 scoop vegan choc protein', amount: '1 ks' },
    ],
    steps: [
    ],
    allergens: ['dairy', 'nuts'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Top: jogurt, med, walnuts', amount: '1 PL' },
    ],
    steps: [
    ],
    allergens: ['dairy', 'eggs', 'gluten'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Sauce: sea soľ, cesnak powder, cumin, chili powder, turmeric', amount: 'podľa chuti' },
    ],
    steps: [
    ],
    allergens: ['gluten', 'soy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Rye mountain chlieb (turkey)', amount: '2 plátky' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Dressing: olivový olej, dijon, tahini, med, citrón', amount: '1 PL' },
    ],
    steps: [
    ],
    allergens: [],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Rye mountain chlieb (ham)', amount: '2 plátky' },
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Rye mountain chlieb (kuracie mäso)', amount: '200 g' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Dressing: sesame seeds, javorový sirup, sesame olej, ryža vinegar, tamari, chilli paste', amount: '80 g' },
    ],
    steps: [
    ],
    allergens: ['soy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Ryža papers, ryža noodles, lettuce, avokádo, mrkva, uhorka, mango, mint', amount: '1 ks' },
      { name: 'Peanut sauce: arašidové maslo, javorový sirup, limetka, sójová omáčka', amount: '20 g' },
    ],
    steps: [
    ],
    allergens: ['dairy', 'nuts', 'soy'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Dressing: dijon, olivový olej, apple cider vinegar, med', amount: '1 PL' },
    ],
    steps: [
    ],
    allergens: ['eggs'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Soba noodles, kale, šampiňóny, edamame, broccolini, paprika', amount: '1 ks' },
      { name: 'Teriyaki: sójová omáčka, sesame olej, mirin, cesnak, med', amount: '2 strúčiky' },
    ],
    steps: [
    ],
    allergens: ['gluten', 'soy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Taco shells, 100g tempeh, asian slaw (cabbage, mrkva, špenát), avokádo, paradajka', amount: '1 ks' },
      { name: 'Tamari marinade + dressing (apple cider vinegar, sesame olej, limetka, mustard, sriracha)', amount: '½ ks' },
    ],
    steps: [
    ],
    allergens: ['soy'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Salad: špenát, paradajka, uhorka, mrkva, olives, avokádo', amount: '1 ks' },
    ],
    steps: [
    ],
    allergens: ['gluten'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Cukina, tekvica, cos lettuce, paprika, avokádo, spring cibuľa, coriander, mint, macadamias, cherry paradajky, feta', amount: '1 ks' },
      { name: 'Dressing: zázvor, limetka, med, kokos mlieko', amount: '1 cm' },
    ],
    steps: [
    ],
    allergens: ['dairy'],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Dressing: cesnak, zázvor, lemongrass, tamari, ryba sauce, citrón, javorový sirup', amount: '2 strúčiky' },
    ],
    steps: [
    ],
    allergens: ['fish', 'soy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Wholegrain wrap, hummus, sladké zemiaky, mrkva, cabbage, špenát, paprika, sunflower seeds', amount: '1 ks' },
    ],
    steps: [
    ],
    allergens: ['gluten'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Avokádo-sour smotana-chilli sauce, kukurica cobs, brokolica', amount: '½ ks' },
    ],
    steps: [
    ],
    allergens: ['dairy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Cesnak tofu stir fry', amount: '2 strúčiky' },
      { name: 'Firm tofu, hoisin sauce, sójová omáčka, med, zázvor, chilli, cesnak, sesame olej', amount: '2 strúčiky' },
      { name: 'Brokolica, fazule, carrots, cukina, brown ryža', amount: '80 g' },
    ],
    steps: [
    ],
    allergens: ['soy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Black fazule, brown ryža, walnuts, cumin, paprika, bbq sauce, breadcrumbs', amount: '1 ks' },
      { name: 'Tahini dressing: tahini, cesnak, apple cider vinegar, mandle mlieko', amount: '2 strúčiky' },
    ],
    steps: [
    ],
    allergens: ['dairy', 'nuts'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Israeli couscous, beetroot, tekvica, cibuľa, mrkva, špenát, feta, walnuts, mint', amount: '1 ks' },
      { name: 'Dressing: javorový sirup, balsamic, olivový olej, citrón', amount: '1 PL' },
    ],
    steps: [
    ],
    allergens: ['dairy'],
  ...
  },
  {
    ...
    fiber: 5,
    ingredients: [
      { name: 'Medjool dates, peanuts, dark chocolate, arašidové maslo, kokos olej', amount: '20 g' },
    ],
    steps: [
    ],
    allergens: ['dairy', 'nuts'],
