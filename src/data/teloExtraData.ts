...
export const TeloExtraStaticData = [
  ...
  // 5 min dopaľovačky · diastáza-safe
  { id: 'cv-core-bez-5-4', name: 'Core 5min dopaľovačka #4 (diastáza)',       duration: '5 min', category: 'dopalovacka', body: 'Core/Abs',   equip: 'Bez pomôcok', level: null, diastasis_safe: true, thumb: '/images/r9/lifestyle-core-workout.jpg', description: 'Krátka dopaľovačka na stred tela. Bezpečné aj pri diastáze.' },
  { id: 'cv-core-bez-5-5', name: 'Core 5min dopaľovačka #5 (diastáza)',       duration: '5 min', category: 'dopalovacka', body: 'Core/Abs',   equip: 'Bez pomôcok', level: null, diastasis_safe: true, thumb: '/images/r9/lifestyle-core-workout.jpg', description: 'Krátka dopaľovačka na stred tela. Bezpečné aj pri diastáze.' },
  { id: 'cv-legs-bez-5-3', name: 'Nohy/zadok 5min dopaľovačka #3 (diastáza)', duration: '5 min', category: 'dopalovacka', body: 'Nohy/Zadok', equip: 'Bez pomôcok', level: null, diastasis_safe: true, thumb: '/images/r9/lifestyle-yoga-pose.jpg', description: 'Krátka dopaľovačka na nohy a zadok. Bezpečné aj pri diastáze.' },
  { id: 'cv-legs-bez-5-4', name: 'Nohy/zadok 5min dopaľovačka #4 (diastáza)', duration: '5 min', category: 'dopalovacka', body: 'Nohy/Zadok', equip: 'Bez pomôcok', level: null, diastasis_safe: true, thumb: '/images/r9/lifestyle-yoga-pose.jpg', description: 'Krátka dopaľovačka na nohy a zadok. Bezpečné aj pri diastáze.' },
];
